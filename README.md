...
# fields НЕОБЯЗАТЕЛЬНЫЙ ПАРАМЕТР (Зависит от оплачиваемой услуги), но в большинстве случаев хватает provider (идентификатор провайдера) и account (лицевой счет)
